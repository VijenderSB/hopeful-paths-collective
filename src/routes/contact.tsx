    ...
    <>
      ...
      <section className="container-page py-16 grid gap-10 lg:grid-cols-[1fr_1fr] items-start">
        <div className="space-y-4">
          <a href={telLink} className="flex items-center gap-4 rounded-2xl border border-border bg-card p-5 hover:border-teal">
          ...
          <a href={waLink} target="_blank" rel="noopener" className="flex items-center gap-4 rounded-2xl border border-border bg-card p-5 hover:border-teal">
          ...
          <a href="mailto:care@deaddictify.com" className="flex items-center gap-4 rounded-2xl border border-border bg-card p-5 hover:border-teal">
            <div className="grid h-12 w-12 place-items-center rounded-xl bg-teal text-teal-foreground"><Mail className="h-6 w-6" /></div>
