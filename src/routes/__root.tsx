...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "DeAddictify — Affordable Alcohol & Drug De-Addiction in Delhi NCR" },
      { name: "description", content: "Affordable, psychiatrist-led alcohol & drug de-addiction, rehabilitation and recovery programs across Delhi, Noida, Ghaziabad, Faridabad and Gurugram." },
      { name: "author", content: "DeAddictify" },
      { property: "og:site_name", content: "DeAddictify" },
      { property: "og:type", content: "website" },
      { property: "og:title", content: "DeAddictify — Breaking Addiction. Rebuilding Lives." },
      { property: "og:description", content: "Affordable Alcohol & Drug De-Addiction, Rehabilitation & Recovery in Delhi NCR." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,600;0,700;1,400;1,600&family=Plus+Jakarta+Sans:wght@400;500;600;700&display=swap" },
    ],
    scripts: [
      {
